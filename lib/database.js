...
const _mongo_JadibotDeviceSchema = mongoose.Schema({ apiKey: {
    ...
    unique: true,
    required: true,
}, serverId: String, nameDevice: String, stateStatus: Number, reasonDisconnected: String, user: Object, scan: Object, settings: Object, owner: String, sourceJadibotApiKey: String }, { collection: 'jadibot_device' });
