...
if (
  !global.golangEngine.engineUrl ||
  !global.golangEngine.buildTime ||
  !global.golangEngine.version
) {
  global.log.error(
    'Golang Engine is not initialized. Please check your environment variables.'
  );
  process.exit(0);
}
